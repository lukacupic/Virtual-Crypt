...
export class TpUpdateEvent extends TpEvent {
...
export class LabelController extends BladeController {
  constructor(doc, config) {
...
export class ValueBladeController extends BladeController {
  constructor(config) {
    super(config);
...
export class RackLikeApi extends BladeApi {
...
export class InputBindingController extends LabelController {
  constructor(doc, config) {
    super(doc, config);
...
export class MonitorBindingController extends LabelController {
  constructor(doc, config) {
    super(doc, config);
    this.binding = config.binding;
...
export class RackLikeController extends BladeController {
  constructor(config) {
    super({
      blade: config.blade,
      view: config.view,
...
export class LabeledValueController extends ValueBladeController {
  constructor(doc, config) {
    const viewProps = config.valueController.viewProps;
    super(
      Object.assign(Object.assign({}, config), {
...
export class SeparatorController extends BladeController {
  constructor(doc, config) {
    super(
      Object.assign(Object.assign({}, config), {
...
export class TabPageApi {
  ...
  get title() {
    var _a;
    return (_a = this.controller_.itemController.props.get("title")) !== null &&
      _a !== void 0
      ? _a
      : "";
  }
